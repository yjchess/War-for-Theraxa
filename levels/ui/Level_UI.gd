...
var minimap_square = preload("res://levels/ui/canvas/minimap_square.tscn")
var victory_screen = preload("res://levels/ui/result/victory_screen.tscn")
var defeat_screen = preload("res://levels/ui/result/defeat_screen.tscn")
signal end_turn
